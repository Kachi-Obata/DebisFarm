      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: sc ? "12px 0" : "20px 0", transition: "all .3s ease" }} className={sc ? "nav-s" : ""}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="#" style={{ textDecoration: "none", display: "flex", alignItems: "baseline", gap: 6 }}>
            <span className="sf" style={{ fontSize: 22, color: C.text, letterSpacing: "-.02em" }}>Debis Farms</span>
            <span style={{ fontSize: 10, fontWeight: 500, color: C.muted, letterSpacing: ".12em", textTransform: "uppercase" }}>Nigeria</span>
          </a>
        ...
        <div>
          ...
          <R d={3}>
            <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 24 }}>
              {[{ l: "Email", v: "info@debisfarms.ng" }, { l: "Phone", v: "+234 (0) 800 123 4567" }, { l: "Location", v: "Lagos, Nigeria" }].map(c => (
                <div key={c.l}><div style={{ fontSize: 11, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase", color: C.muted, marginBottom: 4 }}>{c.l}</div><div style={{ fontSize: 16, color: C.text }}>{c.v}</div></div>
              ))}
            </div>
          </R>
        </div>
    ...
    <footer style={{ background: C.bgDark, padding: "64px 32px 32px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 40, paddingBottom: 40, borderBottom: "1px solid rgba(232,229,221,.1)" }}>
          <div>
            <span className="sf" style={{ fontSize: 20, color: C.light }}>Debis Farms</span>
            <span style={{ fontSize: 10, fontWeight: 500, color: C.lightMuted, letterSpacing: ".12em", textTransform: "uppercase", marginLeft: 6 }}>Nigeria</span>
            <p style={{ fontSize: 14, color: C.lightMuted, marginTop: 12, maxWidth: 280, lineHeight: 1.6 }}>Cultivating excellence across Nigeria, one harvest at a time.</p>
          </div>
